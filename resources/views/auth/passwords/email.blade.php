                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-12 col-sm-4">
                        <div class="sub_title_section">
                            <ul class="sub_title">
                                <li> <a href="{{ route('customer.main') }}"> {{ __('Main') }} </>&nbsp; / &nbsp; </li>
                        ...
                        <div class="login_form_wrapper">
                            <form method="POST" action="{{ route('forgot_password.email') }}">
                                ...
                                <div class="form-group icon_form comments_form">
                                    ...
                                    <input id="login" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="{{ __('Email') }}" required autofocus>
                                ...
                                <div class="about_btn login_btn float_left">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="{{ __('reset') }}" style="display:block; width:100%;">
                                </div>
                                <div class="dont_have_account float_left">
                                    <p>{{ __('You_dont_have_account?') }} <a href="{{ route('register') }}">{{ __('Register') }}</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
