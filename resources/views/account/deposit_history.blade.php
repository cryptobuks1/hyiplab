...
@section('title', __('List_of_closed_deposits'))
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="sv_heading_wraper">
                        ...
                        <h3>{{ __('List_of_closed_deposits') }}</h3>
                ...
                @if($deposits->count() > 0)
                    <table class="table table-striped table-bordered mt-4">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ __('Date_of_closing') }}</th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                @else
                    <div class="col-lg-12">
                        <div class="alert alert-secondary" role="alert">
                            ...
                            <div class="iq-alert-text">{{ __('Closed_deposits_not_found') }}</div>
                        </div>
                    </div>
                @endif
            </div>
