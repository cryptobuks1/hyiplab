    ...
    <div class="row">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="pay_form">
                        <div class="pay_form_title text-center">Recharge balance with Bitcoins</div>
                        <div class="pay_form_body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="pay_form_bal">BTC</div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        Transaction info: <a href="https://www.blockchain.com/en/search?search={{ $transaction->source }}" target="_blank" class="d-inline">
                                            https://www.blockchain.com/en/search?search={{ $transaction->source }}
                                        </a>
                                    </div>
                                </div>
